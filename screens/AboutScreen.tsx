...
const paragraphs: textInfo[] = [
  {
    title: " About AmazingWallet",
    content: (
      <Text fontSize={17} fontFamily="SourceSansPro">
        Welcome to AmazingWallet, your go-to solution for effortless expense tracking and budget
        management.
      </Text>
    ),
  },
  ...
  {
    title: " Why AmazingWallet:",
    content: (
      <Text fontSize={17} fontFamily="SourceSansPro" flexWrap="wrap">
        Tracking your expenses shouldn't be complicated. AmazingWallet keeps it simple, focusing on
  ...
  },
  {
    ...
    content: (
      <Text fontSize={17} fontFamily="SourceSansPro" flexWrap="wrap">
        AmazingWallet has the goal is aiming to simplify expense management, allowing you to make
